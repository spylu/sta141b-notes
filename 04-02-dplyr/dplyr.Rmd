...
Interested reader could install it by (a toolchain would be required to install it from source)
...
Suppose, we want to compuate the mean for the all numeric columns of `flights`. Naively, we could do
...
flights %>%
  ...
  summarize(
    ...
    across(ends_with("delay"), mean, na.rm = TRUE, trim = 0.8),
  )
```
